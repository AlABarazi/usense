...
//         if (this.props.selectedrooms) {

//           this.setState({checked:this.props.selectedrooms})
//             resolve(this.props.selectedrooms);
//         } else {
//             const reason = new Meteor.Error('Invalid-shit', 'Name is required');
//             Meteor.call('userdata.insert');
//             reject(reason);
//         }
//
//     }
