...
import {selectavator} from '../ui/Avatars';
...
Meteor.methods({
    ...
    'userdata.insert' (userid) {
      ...
      return UserData.insert({userId: userid, avatar:selectavator(), lectures: [], rooms: [], answeredquestions: [], points: 0, badge:"unhatched",show:true});
    },
