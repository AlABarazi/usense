...
class BodyForm extends Component {
  ...
  doCalc= () =>{
    ...
    if (finalBmi < 18.5) {
      this.props.meteorCall('userdata.update.bmi',"something","thin",finalBmi,myAge,myWeight,myHeight);
      return "You are thin."
    }
    if (finalBmi > 18.5 && finalBmi < 25) {
      this.props.meteorCall('userdata.update.bmi',"something","healthy",finalBmi,myAge,myWeight,myHeight);
      return "Your weight is fine."
    }
    if (finalBmi > 25) {
      this.props.meteorCall('userdata.update.bmi',"something","extra",finalBmi,myAge,myWeight,myHeight);
