...
class Cloth extends React.Component {
  ...
  render() {
    ...
    <Grid container className={classes.root} >
      ...
      <Grid container className = {this.props.listExists && this.props.clothselection.resultcategory === "naked"? classes.highlight:classes.choices}  alignItems='center' spacing={8}>
        <Grid xs={2}   item >
      ...
      <Grid container className={this.props.listExists && this.props.clothselection.resultcategory === "normal"? classes.highlight:classes.choices}  alignItems='center' spacing={8}>
        <Grid  xs={2}  item >
      ...
      <Grid container className={this.props.listExists && this.props.clothselection.resultcategory === "desert"? classes.highlight:classes.choices}  alignItems='center'  spacing={8}>
        <Grid xs={2}   item >
