...
class MenuAppBar extends React.Component {
  ...
  handleHighScores=()=>{
    browserHistory.push('/highscores')
  }
            ...
            {auth && (
              <div>
                ...
                >
                  ...
                  <Avatar alt="Remy Sharp" src={this.props.userdatalist_exist && this.props.userdatalist.avatar} className={classes.avatar} />
                  {/* <AccountCircle /> */}
                </IconButton>
                <Menu
                  id="menu-appbar"
                ...
                >
                  ...
                  <MenuItem onClick={this.handleHighScores}>High Scores</MenuItem>
                </Menu>
              </div>
            )}
          </Toolbar>
            ...
            >
              <div style={{
                ...
                <List>
                  ...
                  <List>
                          <ListItem button onClick={(e)=>{this.handleChangeBodyState(e,'mytickets')}}>
                          <ListItemAvatar>
                            <Avatar>
                              <LocalMoviesIcon/>
                            </Avatar>
                    ...
                    <List>
                            ...
                            <ListItemText primary="Get New Badges"/>
                          </ListItem>
...
const userdatalist =   UserData.findOne({userId:Meteor.userId()});
