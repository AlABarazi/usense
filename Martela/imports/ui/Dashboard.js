...
class AutoGrid extends React.Component {
  ...
  render() {
                  ...
                  this.props.userdata && this.props.userdata.lectures.filter((item) => {
                    ...
                    return (
                      <div  key={lecturedoc.lectureName} >
                        <VoteCard  ratetype="happysad" title={`Working environment:${lecturedoc.lectureName}`} type="nottotal" category="lecture" item ={lecturedoc.lectureName} rate={lecturedoc.lectureRate}/>
                  ...
                  this.props.userdata && this.props.userdata.rooms.filter((item) => {
                    ...
                    return (
                      <div  key={roomdoc.roomName}  >
                        <VoteCard   ratetype="likedislike" title={`The environment of this space`} type="nottotal" category="room" item ={roomdoc.roomName} rate={roomdoc.roomRate}/>
                        <VoteCard  ratetype="happysad" title={`Good as ${roomdoc.roomName}`} type="nottotal" category="thermal" item ={roomdoc.roomName} rate={roomdoc.thermalRate}/>
                      </div>
    ...
    <br/>Scan the QR for rooms that you visit  by clicking on "+" <br/>
    See what kind of creature you are compared with others around you.
    Watch yourself growing after you hatch as you know more about yourself and your living envrionment.
    <br/>
    <br/>
    To be continued....
    </Typography>
    ...
    <div>
      ...
      <br/>
    <Typography type="caption" gutterBottom align="left">
    You decided to leave your egg. Come meet us and claim your prize.
    <br/>
